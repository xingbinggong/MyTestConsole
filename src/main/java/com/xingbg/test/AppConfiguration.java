    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "com.xingbg.test");
                servletContext.setInitParameter("tapestry.development-modules", "com.xingbg.test.services.DevelopmentModule");
